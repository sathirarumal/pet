    ...
    <div class="content">    
        <div class="contert-wrapper pb-15">
            <div class="cell pb-30">
                <h1 class="title">Food Management </h1>
                       ...
                       <div class="col-md-12">
                                    <div class="row form-row">    
                                        ...
                                        <div class="col-md-4 input-layout">                                            
                                            ...
                                            <input type="text" class="" id="fdname">
                                        </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 input-layout">
                                            <h4 class="title">Food Period</h4>
                                            <input type="text" class="" id="ftype">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-row">    
                                        <div class="col-md-4 input-layout">
                                            ...
                                            <input type="text" class="" id="Tfood">
                                        </div>
                                    </div>   
                                    ...
                                    <div class="row form-row">     
                                        <div class="col-md-4 input-layout">
                                            ...
                                            <input type="text" class="" id="status">
                                        </div>
