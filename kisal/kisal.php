       ...
       =====================================================================-->
        ...
        <!-- =====================================================================-->
             <?php $root=$_SERVER['DOCUMENT_ROOT'];
              ...
              include("$root/pet/Controllers/insertAdmin.php");
              include("$root/pet/Controllers/insertBreed.php");
              include("$root/pet/Controllers/insertCountry.php");
              include("$root/pet/Controllers/insertPeriod.php");
