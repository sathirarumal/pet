(function () {
    'use strict';
    angular.module('app').controller('MainController', ['$scope', 'dataService', '$rootScope', function ($scope, dataService, $rootScope) {
        var vm = this;
        vm.actionString = "[{\"name\":\"Add\",\"icon\":\"fa fa-plus-circle\",\"callBack\":\"add\"},{\"name\":\"Manage\",\"icon\":\"fa fa-users\",\"callBack\":\"abn\"},{\"name\":\"Edit\",\"icon\":\"fa fa-pencil\",\"callBack\":\"edit\"},{\"name\":\"Delete\",\"icon\":\"fa fa-minus-circle\",\"callBack\":\"del\"}]";
        vm.treeData = {};
        ...
        function onInit() {
            dataService.browseHierarchy().then(function (resp) {
                vm.treeData = resp;
                vm.treeIsReady = true;
            }).catch(function (err) {
                console.error(err);
            });
            dataService.browseAll().then(function (resp) {
